...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_AuthReq, _impl_.nickname_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_BroadcastLeaveRoom, _impl_.room_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 1731, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Protocol.C_AuthReq.nickname"));
        } else
          goto handle_unusual;
        continue;
      default:
...
class S_SelectRoomRes::_Internal {
 public:
  static const ::Protocol::RoomListItemInfo& room(const S_SelectRoomRes* msg);
};

const ::Protocol::RoomListItemInfo&
...
class S_CreateRoomRes::_Internal {
 public:
  static const ::Protocol::RoomDetailInfo& room(const S_CreateRoomRes* msg);
};
...
class S_JoinRoomRes::_Internal {
 public:
  static const ::Protocol::RoomDetailInfo& room(const S_JoinRoomRes* msg);
};
...
class S_BroadcastLeaveRoom::_Internal {
 public:
  static const ::Protocol::RoomDetailInfo& room(const S_BroadcastLeaveRoom* msg);
};

const ::Protocol::RoomDetailInfo&
S_BroadcastLeaveRoom::_Internal::room(const S_BroadcastLeaveRoom* msg) {
  return *msg->_impl_.room_;
}
void S_BroadcastLeaveRoom::clear_room() {
  if (GetArenaForAllocation() == nullptr && _impl_.room_ != nullptr) {
    delete _impl_.room_;
  }
  _impl_.room_ = nullptr;
