...
//bool Handle_S_MatchRes(PacketSessionRef& session, Protocol::S_MatchRes& pkt);
...
public:
	...
	//static SendBufferRef MakeSendBuffer(Protocol::C_MatchReq& pkt) { return MakeSendBuffer}
